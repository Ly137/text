...
<head>
    ...
    <title>基于GitHub的教学管理系统——实验管理</title>
                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      <c:forEach var="a" items="${alist }">
                        <tr>                         
						  ...
						  <td>${a.title }</td>
                          <td class="text-right">
                            <a href="<%=basePath %>GetDataSvlt?id=${a.id }&tbname=TteaTask" class="btn btn-secondary btn-sm">详情</a>                            
                          </td>                         
                        </tr>
                        </c:forEach>
                      </tbody>
            		...
            		<div class="col-auto ml-lg-auto">
		              <div class="row align-items-center">		                
		                <div class="col-auto">
					      ...
					      <div>
					      <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','tshiyan');return false;"><i class="fe fe-chevrons-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','tshiyan');return false;"><i class="fe fe-chevron-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','tshiyan');return false;"><i class="fe fe-chevron-right"></i></a>                
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','tshiyan');return false;"><i class="fe fe-chevrons-right"></i></a>		              			               		             
		                 </div>
