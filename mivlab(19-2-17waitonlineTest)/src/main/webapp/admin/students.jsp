...
<head>
    ...
    <title>基于GitHub的教学管理系统——学生信息管理</title>
...
<div class="page">
                     ...
                     <div class="col-md-12 col-lg-12 ">                      	
                       <div class="card-body">	                    
                        <div class="row gutters-xs">
                          ...
                          <div class="col-4 col-lg-2 col-md-6">	
                          	<input type="search" class="form-control header-search"  id="ckuname" placeholder="请输入学号&hellip;" tabindex="1">			                                                                                      	                             
                          ...
                          <div class="col-4 col-lg-1 col-md-6">	                          
                             <button class="btn btn-block"  onclick="showExlModel();return false;" >导入</button>	                            	                             
                          </div> 	 
                          <div class="col-4 col-lg-1 col-md-6">	                          
            		...
            		<div class="col-auto ml-lg-auto">
		              <div class="row align-items-center">		                
		                <div class="col-auto">
					      ...
					      <div>
					      <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','students');return false;"><i class="fe fe-chevrons-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','students');return false;"><i class="fe fe-chevron-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','students');return false;"><i class="fe fe-chevron-right"></i></a>                
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','students');return false;"><i class="fe fe-chevrons-right"></i></a>		              			               		             
		                 </div>
      ...
      <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="gsno" name="gsno"  class="form-control" placeholder="学号">
                    </div>
                    <div class="form-group">
                        <label for="gsname">姓名</label>
                        <input type="text" id="gsname"  name="gsname"  class="form-control"  placeholder="姓名">
                    </div>
                    <div class="form-group">
                        <label for="gsgender">性别</label>
                        <select id="gsgender" class="form-control custom-select">
							<option>男</option>
							<option>女</option>               
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="gclassinfo_id">班级</label>
                        <select id="gclassinfo_id" class="form-control custom-select">
							<option value="0">选择班级</option>
                            <c:forEach var="s" items="${classinfolist }">
                              <option value="${s.id }">${s.classname }</option>	               
                            </c:forEach>
                    ...
                    <div class="form-group">
                        <label for="gsphone">电话</label>
                        <input type="text" id="gsphone" name="gsphone"  class="form-control" placeholder="电话">
                    </div>
                    <div class="form-group">
                        <label for="gspassword">密码</label>
                        <input type="text" id="gspassword"  name="gspassword"  class="form-control"  placeholder="密码">
                    </div>
                </div>
       ...
       <!-- dialog id="myModal" end  -->
       
       
       <!-- dialog  id="dlgExlModel" 导入Excel表 step1 start -->
      <div class="modal fade" id="dlgExlModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"></h4>
                ...
                <div class="modal-body">
                    <div class="form-group">
                    	...
                    	<h4>注意：第一列为名称，列顺序如图，每列为字符型数据</h4>
						<h4>使用表为：sheet1</h4>
                        <img alt="excelModel" src="<%=basePath%>images/ExcelModel.png" width="100%" height="auto">
                    </div>                  
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>关闭</button>
                    <button type="button" id="btn_submit" class="btn btn-primary" data-dismiss="modal" onclick="importStu();return false;"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>下一步</button>
                </div>
            </div>
          </div>
       </div>
       <!-- dialog id="dlgExlModel" end  -->
       <!-- dialog  id="dlgSelectclass" 导入Excel表 step2 start -->
      <div class="modal fade" id="dlgSelectclass" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"></h4>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="Importgclassinfo_id">班级</label>
                        <select id="Importgclassinfo_id" class="form-control custom-select">
							<option value="0">选择班级</option>
                            <c:forEach var="s" items="${classinfolist }">
                              <option value="${s.id }">${s.classname }</option>	               
                            </c:forEach>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>关闭</button>
                    <button type="button" id="btn_submit" class="btn btn-primary" data-dismiss="modal" onclick="nextStepToExcel();return false;"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>下一步</button>
                </div>
            </div>
          </div>
       </div>
       <!-- dialog id="dlgSelectclass" end  -->
       <!-- dialog  id="dlgImportExcel" 导入Excel表 step3start -->
       <div class="modal fade" id="dlgImportExcel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"></h4>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span>关闭</button>
                    <button type="button"  id='upFile-btn'  class="btn btn-primary" data-dismiss="modal" ><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>导入</button>
                </div>
            </div>
          </div>
       </div>
       <!-- dialog id="dlgImportExcel" end  -->
    </div>
	...
	function showExlModel(){
		$('#dlgExlModel').modal();
	}
	function importStu(){	
				
		//打开选择班级对话框
		$("#Importgclassinfo_id").val("0");
		$('#dlgSelectclass').modal();
	};
	
	function nextStepToExcel(){
		var Importgclassinfo_id=$("#Importgclassinfo_id").val();
		if(Importgclassinfo_id=="0"){
			alert("请选择班级信息");
			return;
		}else{		//选择班级后，打开选择Excel文件对话框
			$.ajax({
				url:'AddSvlt',
				type:'post',
				dataType:'json',
				data:{"tbname":"studentsImportCid",'cid':Importgclassinfo_id},
				success:function(data){																		
						$('#dlgImportExcel').modal();				
				}
			});
	...
	function updbt(id){
			...
			success:function(data){	
				...
				$("#gsno").val(ob.sno);
				$("#gsname").val(ob.sname);
				$("#gsgender").val(ob.sgender);
				$("#gclassinfo_id").val(ob.classinfo_id);
				$("#gsphone").val(ob.sphone);
				$("#gspassword").val(ob.spassword);
			}
		});
	}
	//保存
	function gltj(){
	var sno=$("#gsno").val();
	var sname=$("#gsname").val();
	var sgender=$("#gsgender").val();
	var classinfo_id=$("#gclassinfo_id").val();
	var sphone=$("#gsphone").val();
	var spassword=$("#gspassword").val();
	var id=$("#idi").val();
	var flag=$("#flagi").val();
