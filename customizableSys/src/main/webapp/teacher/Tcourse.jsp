							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
								...
								<c:forEach var="a" items="${alist }">
									<tr>
										...
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a class="releaseBtn" href="<%=basePath %>GetDataSvlt?tbname=teacourse&planid=${a.id}"><img src="images/release.png" width="14" height="14" />发布作业</a></span></div></td>
									</tr>
								</c:forEach>
							</table></td>
						</tr>
