...
<html>
	<head>
		...
		<script type="text/javascript">
			function addbt(){
				$("#flagi").val("add");
				$("#gclassno").textbox('setValue','');
				$("#gclassname").textbox('setValue','');
				$("#dlg").dialog('open');
			...
			function updbt(id){
				...
				success:function(data){	
					...
					$("#dlg").dialog('open');
					$("#dlg").dialog({modal:true});
					$("#gclassno").textbox('setValue',ob.classno);
					$("#gclassname").textbox('setValue',ob.classname);
				}
			});
		}
		//保存
		function gltj(){
			var classno=$("#gclassno").textbox('getValue');
			var classname=$("#gclassname").textbox('getValue');
			var id=$("#idi").val();
			var flag=$("#flagi").val();
			if(classno==""||classname==""){
				alert('班级信息不完整。');
				return;
			}
			if("add"==flag){
				$.ajax({
					url:'AddSvlt',
					type:'post',
					data:{"tbname":"classinfo","classno":classno,"classname":classname},
					dataType:'json',
					success:function(data){
						alert(data.msg);
					}
				...
				$.ajax({
					url:'UpdSvlt',
					type:'post',
					data:{"tbname":"classinfo","id":id,"classno":classno,"classname":classname},
					dataType:'json',
					success:function(data){
						alert(data.msg);
					}
		...
		//取消
		function rst(){
			window.location.href="InitSvlt?tbname=classinfo";
		}
		//查询
		function cktj(){
			var sqls="select  classinfo.* from  classinfo where 1=1 ";
			var un=$("#ckuname").textbox('getValue');
			if(un!=""){
				sqls+=" and classname like '%"+un+"%'";
			}
			$.ajax({
				url:'CkSvlt',
				type:'post',
...
<body>	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="STYLE7" style="padding-left: 50px;">班级信息管理</td>
					<td style="padding-right:10px;"><div align="right" style="padding-right: 50px;">
						<table border="0" align="right" cellpadding="0" cellspacing="0">
							<tr>
								<td class="STYLE3">
									班级名称：<input id="ckuname" class="ckinput easyui-textbox"/>
								</td>
								<td width="60">
						...
						<tr>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
								<tr>
									...
									<td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">班级编号</span></strong></div></td>
									<td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">班级名称</span></strong></div></td>
								...
								<c:forEach var="a" items="${alist }">
									<tr>
										...
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">${a.classno }</span></div></td>
										...
										<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td><table border="0" align="right" cellpadding="0" cellspacing="0">
													<tr>
														<td width="40"><a href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','classinfo');return false;"><img src="images/first.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','classinfo');return false;"><img src="images/back.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','classinfo');return false;"><img src="images/next.gif" width="37" height="15"/></a></td>
														<td width="40"><a href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','classinfo');return false;"><img src="images/last.gif" width="37" height="15"/></a></td>
				...
				<div id="dlg" class="easyui-dialog" title=" "  style="width:100%;max-width:400px;padding:30px 60px;">
					<form id="ff" method="post">
						<div style="margin-bottom:20px">
							<input id="gclassno" class="easyui-textbox" name="gclassno" style="width:100%"  data-options="label:'班级编号:'"/>
						</div>
						<div style="margin-bottom:20px">
							<input id="gclassname" class="easyui-textbox" name="gclassname" style="width:100%"  data-options="label:'班级名称:'"/>
						</div>
					</form>
