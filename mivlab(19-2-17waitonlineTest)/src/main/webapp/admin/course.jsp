...
<head>
    ...
    <title>基于GitHub的教学管理系统——课程信息管理</title>
                       ...
                       <div class="card-body">	                    
                        <div class="row gutters-xs">
                          ...
                          <div class="col-4 col-lg-2 col-md-6">	
                          	<input type="search" class="form-control header-search"  id="ckuname" placeholder="请输入课程名称&hellip;" tabindex="1">			                                                                                      	                             
            		...
            		<div class="col-auto ml-lg-auto">
		              <div class="row align-items-center">		                
		                <div class="col-auto">
					      ...
					      <div>
					      <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','course');return false;"><i class="fe fe-chevrons-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','course');return false;"><i class="fe fe-chevron-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','course');return false;"><i class="fe fe-chevron-right"></i></a>                
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','course');return false;"><i class="fe fe-chevrons-right"></i></a>		              			               		             
		                 </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="gcno">课程编号</label>
                        <input type="text" id="gcno" name="gcno"  class="form-control" placeholder="课程编号">
                    </div>
                    <div class="form-group">
                        <label for="gcname">课程名称</label>
                        <input type="text" id="gcname"  name="gcname"  class="form-control"  placeholder="课程名称">
                    </div>
