						...
						<tr>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
								<tr>
									...
									<td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">发布日期</span></strong></div></td>
									<td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">截止日期</span></strong></div></td>
								...
								<c:forEach var="a" items="${alist }">
									<tr>
										...
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">${a.time }</span></div></td>										
										<td height="22" bgcolor="#FFFFFF" ><div align="center"><span class="STYLE3 deadline">${a.deadline }</span></div></td>
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a class="details" href="/customizableSys/GetDataSvlt?id=${a.id }&tbname=teaTask"><img src="images/details.png" width="14" height="14" /></a></span></div></td>
									</tr>
								</c:forEach>
							</table></td>
						</tr>
