...
<head>
    ...
    <title>基于GitHub的教学管理系统——二级标题管理>新增</title>
                      ...
                      <div class="col-md-6 col-lg-12 card">
	                    ...
	                    <fieldset class="form-fieldset">
	                        ...
	                        <div class="form-group">
	                          ...
	                          <textarea class="form-control" name='snav_name' id="snav_name"  maxlength="200" class="form-control" ></textarea>
	                        </div>
	                        <div class="form-group">
	                        ...
	                        <div class="form-footer">
		                      <button class="btn btn-primary btn-block" onclick="onSubmit()">新 增</button>
		                    </div>                       
	                      </fieldset>
                      </div>
        			 </div>        			  
