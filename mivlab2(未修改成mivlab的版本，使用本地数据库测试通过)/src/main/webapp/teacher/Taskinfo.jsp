...
<header class="am-topbar am-topbar-fixed-top">	
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title"><span class="fa fa-mail-reply backward" ></span> 实验管理>详情</h4></li>
				</ul>
							...
							<div class="card-box">
									...
									<table class="row" border="0" cellpadding="0" cellspacing="0" style="width:80%" align="center">
										...
										<tr>
											...
											<p align="center">
												<button class="button showeditor" style="vertical-align:middle" type="button"><span>编辑 </span></button>
											</p>
								...
								<fieldset style="height:100%; margin:30px;">
									<span style="display:block;text-align:center;color:black;border:1px solid #6d0404;background:#d9e0fb59;padding:5px;box-shadow: 0 2px 2px 0 rgba(0,0,0,0.2), 0 2px 2px 0 rgba(0,0,0,0.19);">编辑区</span>			
