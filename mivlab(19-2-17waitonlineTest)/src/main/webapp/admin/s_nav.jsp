...
<head>
    ...
    <title>基于GitHub的教学管理系统——二级标题管理</title>
                       ...
                       <div class="card-body">	                    
                        <div class="row gutters-xs">
                          <div class="col-4 col-lg-2 col-md-6">	
                          	<input type="search" class="form-control header-search"  id="ckuname" placeholder="请输入二级标题&hellip;" tabindex="1">			                                                                                      	                             
                          ...
                          <div class="col-4 col-lg-1 col-md-6">	                          
                             <button class="btn btn-block" onclick="adds_nav()" >新增</button>	                            	                             
                          </div>  
                      ...
                      <c:forEach var="a" items="${alist }">
                        <tr>                         
		                  ...
		                  <td>${a.name }</td>
               			  <td>${a.snav_name }</td>                
                          <td class="text-right">
                            <a href="<%=basePath%>GetDataSvlt?id=${a.id }&tbname=snav"   class="btn btn-secondary btn-sm">详情</a>                            
                          </td>                         
                        </tr>
                        </c:forEach>
                      </tbody>
            		...
            		<div class="col-auto ml-lg-auto">
		              <div class="row align-items-center">		                
		                <div class="col-auto">
					      ...
					      <div>
					      <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','snav');return false;"><i class="fe fe-chevrons-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','snav');return false;"><i class="fe fe-chevron-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','snav');return false;"><i class="fe fe-chevron-right"></i></a>                
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','snav');return false;"><i class="fe fe-chevrons-right"></i></a>		              			               		             
		                 </div>
