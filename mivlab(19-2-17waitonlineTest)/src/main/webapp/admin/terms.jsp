...
<head>
    ...
    <title>基于GitHub的教学管理系统——学期信息管理</title>
...
<div class="page">
                       ...
                       <div class="card-body">	                    
                        <div class="row gutters-xs">
                          ...
                          <div class="col-4 col-lg-2 col-md-6">	
                          	<input type="search" class="form-control header-search"  id="ckuname" placeholder="请输入学期名称&hellip;" tabindex="1">			                                                                                      	                             
            		...
            		<div class="col-auto ml-lg-auto">
		              <div class="row align-items-center">		                
		                <div class="col-auto">
					      ...
					      <div>
					      <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','terms');return false;"><i class="fe fe-chevrons-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','terms');return false;"><i class="fe fe-chevron-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','terms');return false;"><i class="fe fe-chevron-right"></i></a>                
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','terms');return false;"><i class="fe fe-chevrons-right"></i></a>		              			               		             
		                 </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="gtermno">学期编号</label>
                        <input type="text" id="gtermno" name="gtermno"  class="form-control" placeholder="学期编号">
                    </div>
                    <div class="form-group">
                        <label for="gtermname">学期名称</label>
                        <input type="text" id="gtermname"  name="gtermname"  class="form-control"  placeholder="学期名称">
                    </div>
	...
	function updbt(id){
		...
		success:function(data){	
			...
			$("#idi").val(id);
			$('#myModal').modal();
			$("#gtermno").val(ob.termno);
			$("#gtermname").val(ob.termname);
		}
	});
	}
	//保存
	function gltj(){
	var termno=$("#gtermno").val();
	var termname=$("#gtermname").val();
	var id=$("#idi").val();
	var flag=$("#flagi").val();
	if(termno==""||termname==""){
		alert('学期信息不完整。');
