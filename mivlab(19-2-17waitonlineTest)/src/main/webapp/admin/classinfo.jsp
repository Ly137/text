...
<head>
    ...
    <title>基于GitHub的教学管理系统——班级信息管理</title>
                       ...
                       <div class="card-body">	                    
                        <div class="row gutters-xs">
                          ...
                          <div class="col-4 col-lg-2 col-md-6">	
                          	<input type="search" class="form-control header-search"  id="ckuname" placeholder="请输入班级名称&hellip;" tabindex="1">			                                                                                      	                             
            		...
            		<div class="col-auto ml-lg-auto">
		              <div class="row align-items-center">		                
		                <div class="col-auto">
					      ...
					      <div>
					      <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','classinfo');return false;"><i class="fe fe-chevrons-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','classinfo');return false;"><i class="fe fe-chevron-left"></i></a>
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','classinfo');return false;"><i class="fe fe-chevron-right"></i></a>                
		                  <a class=" btn btn-sm btn-outline-primary" href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','classinfo');return false;"><i class="fe fe-chevrons-right"></i></a>		              			               		             
		                 </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="gclassno">班级编号</label>
                        <input type="text" id="gclassno" name="gclassno"  class="form-control" placeholder="班级编号">
                    </div>
                    <div class="form-group">
                        <label for="gclassname">班级名称</label>
                        <input type="text" id="gclassname"  name="gclassname"  class="form-control"  placeholder="班级名称">
                    </div>
    ...
    <script type="text/javascript">   		   
		...
		function updbt(id){
			...
			success:function(data){	
				...
				$("#idi").val(id);
				$('#myModal').modal();
				$("#gclassno").val(ob.classno);
				$("#gclassname").val(ob.classname);
			}
		});
		}
		//保存
		function gltj(){
		var classno=$("#gclassno").val();
		var classname=$("#gclassname").val();
		var id=$("#idi").val();
		var flag=$("#flagi").val();
