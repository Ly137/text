...
<body>	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="STYLE7" style="padding-left: 50px;">实验管理</td>
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
								...
								<c:forEach var="a" items="${alist }">
									<tr>
										...
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a class="details" href="/customizableSys/GetDataSvlt?id=${a.id }&tbname=TteaTask"><img src="images/details.png" width="14" height="14" />详情</a></span></div></td>
									</tr>
								</c:forEach>
							</table></td>
						</tr>
