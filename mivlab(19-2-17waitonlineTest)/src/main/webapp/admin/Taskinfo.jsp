...
<head>
    ...
    <title>基于GitHub的教学管理系统——教师实验记录>详情</title>
...
<div class="page">
            ...
            <div class="row row-cards">
              <div class="col-12 card">              
                  <div class="page-header">		                
		              <h1 class="page-title">
		                 <a href="<%=basePath %>InitSvlt?flgs=1&tbname=allshiyan"><i class="fe fe-corner-up-left" ></i></a>
		                	教师实验记录>详情
		              </h1>
		          </div>
                  <div class="card-body">
	...
	$(document).ready(function(){
		...
		/*返回按钮*/
		function redirect(){
			  window.location.href="<%=basePath%>InitSvlt?flgs=1&tbname=allshiyan";
		};
