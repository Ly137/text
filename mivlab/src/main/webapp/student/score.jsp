	...
	<header class="am-topbar am-topbar-fixed-top">	
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">GitHub实验成绩</h4></li>
				</ul>
					...
					<div class="am-g">
						...
						<div class="am-u-sm-12 am-u-md-6">
				          <div class="am-input-group am-input-group-sm">
							 ...
							 课程：<select id="ccoursesid"  class="ckinput easyui-combobox" >
	...
	<div class="am-u-sm-12">
     <!--    <form class="am-form">  --> 
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
                <th class="table-check"></th><th class="table-title">学期</th><th >课程</th><th >学号</th><th>姓名</th><th>成绩</th>
              </tr>
              </thead>
              <tbody>
            ...
            <div class="am-cf">
              ...
              <div class="am-fr">
                <ul class="am-pagination">
                  <li ><a href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','Sscore');return false;">«</a></li>
                  <li ><a href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','Sscore');return false;">&lt;</a></li>
                  <li ><a href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','Sscore');return false;">&gt;</a></li>                 
                  <li><a href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','Sscore');return false;">»</a></li>
                </ul>
              </div>
            </div>
