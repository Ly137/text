...
//打开编辑区	
  ...
  /*返回按钮*/
  $(".btnF").click(function(){
	  window.location.href="<%=basePath%>InitSvlt?flgs=1&tbname=stutaskinfo"; 
  });
  /*提交按钮*/
...
<header class="am-topbar am-topbar-fixed-top">	
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title"><span class="fa fa-mail-reply backward" ></span> 实验任务>详情</h4></li>
				</ul>
						...
						<div class="am-u-sm-12">
							<div class="card-box">
								<table class="row" border="0" cellpadding="0" cellspacing="0" style="width:80%" align="center">
									...
									<tr class="edittitle"><td colspan="20"><span style="display:block;text-align:center;color:black;border:1px solid #6d0404;background:#d9e0fb59;padding:5px;box-shadow: 0 2px 2px 0 rgba(0,0,0,0.2), 0 2px 2px 0 rgba(0,0,0,0.19);">编辑区</span>	</td></tr>
									<tr class="editor">
										<td>编辑作业：</td>
									...
									<tr>
										...
										<p align="center">
											...
											<button class="button showeditor" style="vertical-align:middle"  type="button"><span>提交作业 </span></button>
											<button class="button btnF" type="button" style="vertical-align:middle;display:none;"><span>返回 </span></button>
											<button class="button btnSb" type="button" style="vertical-align:middle;display:none;"><span>提交作业 </span></button>
										</p>
