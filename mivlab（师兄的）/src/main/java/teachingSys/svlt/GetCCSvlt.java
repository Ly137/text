...
/**
 * Servlet implementation class GetCCSvlt
 */
@WebServlet("/GetCCSvlt")
public class GetCCSvlt extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		sql="select * from course where id in(select course_id from courseplan where teacher_id="+userid+" and terms_id="+id+")";
		System.out.println(sql);
		List<Course> clist=GetList.getlist(Course.class, db.executeQuery(sql));
