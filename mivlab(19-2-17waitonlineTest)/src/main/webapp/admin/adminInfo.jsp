...
<div class="page">
              ...
              <div class="col-12 card">              
                  ...
                  <div class="card-body">
                    <div class="row ">
                      <div class="col-md-6 col-lg-12 card">
	                    ...
	                    <fieldset class="form-fieldset">
	                        ...
	                        <div class="form-footer">
		                      <button class="btn btn-primary btn-block" onclick="Submit()">更  改</button>
		                    </div>                       
	                      </fieldset>
                      </div>
        			 </div>
        			 <div class="col-md-6 col-lg-12 card">
                        <div class="card-header">
			               <h3 class="card-title">2、GitHub信息</h3>
			            </div>		                  
			            <div class="card-body">			                  	
		                    <fieldset class="form-fieldset">			                   
		                        <div class="form-group">
			            ...
			            <div class="card-body">			                  	
		                    <fieldset class="form-fieldset">			                   
		                        ...
		                        <input type="hidden" class="form-control" id="uname" name="uname" value="${userinfo.id}">
			                    <input type="hidden"  id="tbname" name="tbname" value="admin">
	...
	function SubmitGit(){
		...
		$.ajax({
			...
			type:'post',
			dataType:'json',
			data:{"tbname":"adInfo","id":num,"gitUsername":gitUsername,"TOKEN":TOKEN,"CLIENT_ID":CLIENT_ID,"CLIENT_SECRET":CLIENT_SECRET},
			success:function(data){	
				if(data.msg=="修改成功"){
					alert("修改成功");
