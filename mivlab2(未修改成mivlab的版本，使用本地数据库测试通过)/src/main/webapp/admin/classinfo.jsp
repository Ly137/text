	...
	<header class="am-topbar am-topbar-fixed-top">	
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left ">
					...
					<h4 class="page-title">班级信息管理</h4></li>
				</ul>
					...
					<div class="am-g">
						...
						<div class="am-u-sm-12 am-u-md-3">
				          <div class="am-input-group am-input-group-sm">
				            <input type="text" class="am-form-field" id="ckuname" placeholder="请输入班级名称">	            	
	...
	<div class="am-u-sm-12">
     <!--    <form class="am-form">  --> 
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
                <th class="table-check"></th><th class="table-title">班级编号</th><th>班级名称</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
            ...
            <div class="am-cf">
              ...
              <div class="am-fr">
                <ul class="am-pagination">
                  <li ><a href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','classinfo');return false;">«</a></li>
                  <li ><a href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','classinfo');return false;">&lt;</a></li>
                  <li ><a href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','classinfo');return false;">&gt;</a></li>                 
                  <li><a href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','classinfo');return false;">»</a></li>
                </ul>
              </div>
            </div>
