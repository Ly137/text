...
<html>
	<head>
		...
		function gltj(){
			...
			var id=$("#idi").val();
			var flag=$("#flagi").val();
			if(tno==""||tname==""||sex==""||tphone==""||taddr==""||tpassword==""){
				alert('教师信息不完整。');
				return;
			}
			if("add"==flag){
				$.ajax({
					url:'AddSvlt',
					type:'post',
					data:{"tbname":"teacher","tNo":tno,"tName":tname,"sex":sex,"tPhone":tphone,"tAddr":taddr,"tPwd":tpassword},
					dataType:'json',
					success:function(data){
						alert(data.msg);
					}
				...
				$.ajax({
					url:'UpdSvlt',
					type:'post',
					data:{"tbname":"teacher","id":id,"tNo":tno,"tName":tname,"sex":sex,"tPhone":tphone,"tAddr":taddr,"tPwd":tpassword},
					dataType:'json',
					success:function(data){
						alert(data.msg);
					}
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
								...
								<c:forEach var="a" items="${alist }">
									<tr>
										...
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">${a.sex }</span></div></td>
										...
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">${a.tPwd }</span></div></td>
