            ...
            if (formItems != null && formItems.size() > 0) {
                ...
                for (FileItem item : formItems) {
                	...
                	if("".equals(fileName)) {
                        ...
                        String logoPath="/allProjUpload/customizableSys/LogoImage/"+fileName;
                        int bls=db.executeUpdate("update indexshow set logoPath='"+logoPath+"' where id="+1);
                        if(bls>0){
        					json.put("msg", "logo修改成功");
        				}else{
        					json.put("msg", "修改失败");
        				}
