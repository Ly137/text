...
<html>
	<head>
		...
		<script type="text/javascript">
			function addbt(){
				$("#flagi").val("add");
				$("#gtermno").textbox('setValue','');
				$("#gtermname").textbox('setValue','');
				$("#dlg").dialog('open');
			...
			function updbt(id){
				...
				success:function(data){	
					...
					$("#dlg").dialog('open');
					$("#dlg").dialog({modal:true});
					$("#gtermno").textbox('setValue',ob.termno);
					$("#gtermname").textbox('setValue',ob.termname);
				}
			});
		}
		//保存
		function gltj(){
			var termno=$("#gtermno").textbox('getValue');
			var termname=$("#gtermname").textbox('getValue');
			var id=$("#idi").val();
			var flag=$("#flagi").val();
			if(termno==""||termname==""){
				alert('学期信息不完整。');
			...
			if("add"==flag){
				$.ajax({
					url:'AddSvlt',
					type:'post',
					data:{"tbname":"terms","termno":termno,"termname":termname},
					dataType:'json',
					success:function(data){
						alert(data.msg);
					}
				...
				$.ajax({
					url:'UpdSvlt',
					type:'post',
					data:{"tbname":"terms","id":id,"termno":termno,"termname":termname},
					dataType:'json',
					success:function(data){
						alert(data.msg);
					}
		...
		//取消
		function rst(){
			window.location.href="InitSvlt?tbname=terms";
		}
		//查询
		function cktj(){
			var sqls="select  terms.* from  terms where 1=1 ";
			var un=$("#ckuname").textbox('getValue');
			if(un!=""){
				sqls+=" and termname like '%"+un+"%'";
			}
			$.ajax({
				url:'CkSvlt',
				type:'post',
...
<body>	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="STYLE7" style="padding-left: 50px;">学期信息管理</td>
					<td style="padding-right:10px;"><div align="right" style="padding-right: 50px;">
						<table border="0" align="right" cellpadding="0" cellspacing="0">
							<tr>
								<td class="STYLE3">
									学期名称：<input id="ckuname" class="ckinput easyui-textbox"/>
								</td>
								<td width="60">
						...
						<tr>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
								<tr>
									...
									<td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">学期编号</span></strong></div></td>
									<td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">学期名称</span></strong></div></td>
								...
								<c:forEach var="a" items="${alist }">
									<tr>
										...
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">${a.termno }</span></div></td>
										...
										<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td><table border="0" align="right" cellpadding="0" cellspacing="0">
													<tr>
														<td width="40"><a href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','terms');return false;"><img src="images/first.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','terms');return false;"><img src="images/back.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','terms');return false;"><img src="images/next.gif" width="37" height="15"/></a></td>
														<td width="40"><a href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','terms');return false;"><img src="images/last.gif" width="37" height="15"/></a></td>
				...
				<div id="dlg" class="easyui-dialog" title=" "  style="width:100%;max-width:400px;padding:30px 60px;">
					<form id="ff" method="post">
						<div style="margin-bottom:20px">
							<input id="gtermno" class="easyui-textbox" name="gtermno" style="width:100%"  data-options="label:'学期编号:'"/>
						</div>
						<div style="margin-bottom:20px">
							<input id="gtermname" class="easyui-textbox" name="gtermname" style="width:100%"  data-options="label:'学期名称:'"/>
						</div>
					</form>
