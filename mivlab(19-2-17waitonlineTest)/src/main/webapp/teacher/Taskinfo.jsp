...
<head>
    ...
    <title>基于GitHub的教学管理系统——实验管理>编辑</title>
...
<div class="page">
            ...
            <div class="row row-cards">
              <div class="col-12 card">              
                  <div class="page-header">
		              <h1 class="page-title">
	                	<a href="<%=basePath %>InitSvlt?flgs=1&tbname=tshiyan"><i class="fe fe-corner-up-left" ></i></a>
	                	实验管理>编辑
		              </h1>
		          </div>
                  <div class="card-body">
                    <div class="row ">
                     ...
                     <div class="col-sm-6 col-md-6 col-lg-4">
	                    ...
	                    <div class="form-group">
                          ...
                          <input type="text" disabled="" value="${a.termname}" class="form-control"/>	                              	                         
                        </div>
                      </div>
                      <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="form-group">
                          <label class="form-label">班级</label>
                          <input type="text" disabled="" value="${a.classname}" class="form-control"/>	                              	                         
                        </div>
                      </div>
                       <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="form-group">
                          <label class="form-label">课程名称</label>
                          <input type="text" disabled="" value="${a.cname}" class="form-control"/>	                              	                         
                        </div>
                       </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" disabled="" value="${a.time}" class="form-control"/>	                              	                         
                        </div>
                       </div>
                        <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="form-group">
                          <label class="form-label">最后期限</label>
                          <input type="date" disabled="" value="${a.deadline}" name="deadline" id="deadline" class="form-control"/>	                              	                         
                        </div>
                       </div>
                       <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                          <label class="form-label">作业标题</label>
                           <textarea class="form-control" disabled=""  id="title" name="title">${a.title}</textarea>	 	                              	                         
                        </div>
                       </div>
                       <div class="col-sm-12 col-md-12 col-lg-12 editor"> 
	                        <div class="form-group">
                       ...
                       <div class="col-sm-12 col-md-12 col-lg-12">                        
                        <div class="form-footer">
	                      <button class="btn btn-primary btn-block showeditor" >编 辑</button>
	                      <button class="btn btn-primary  ml-auto btnF" style="display:none;"  onclick="redirect()">返 回</button>
		                  <button class="btn btn-primary  ml-auto btnSb" style="display:none;" onclick="onSubmit()">提 交</button>
	                    </div>  
	                   </div> 
	...
	$(document).ready(function(){
		...
		/*返回按钮*/
		function redirect(){
			  window.location.href="<%=basePath%>InitSvlt?flgs=1&tbname=tshiyan";
		};
