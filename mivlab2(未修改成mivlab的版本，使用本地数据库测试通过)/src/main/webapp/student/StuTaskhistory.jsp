	...
	<header class="am-topbar am-topbar-fixed-top">	
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">实验记录</h4></li>
				</ul>
	...
	<div class="am-u-sm-12">
     <!--    <form class="am-form">  --> 
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
              <tr>
                <th class="table-check"></th><th class="table-title">学期</th><th >课程</th><th class="table-type">实验标题</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <a href="<%=basePath %>GetDataSvlt?id=${a.id }&tbname=stuTask">
