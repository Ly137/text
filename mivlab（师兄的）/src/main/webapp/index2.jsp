...
<!--  	<link rel="stylesheet" href="css/default.css" />-->
	<!--[if (gte IE 9)|!(IE)]><!-->
	<script type="text/javascript" src="/mivlab/lib/jquery/jquery-3.3.1.min.js"></script>
	<!--<![endif]-->
	<!--[if lte IE 8 ]>
	...
	<![endif]-->
	<script type="text/javascript" src="/mivlab/lib/handlebars/handlebars.min.js"></script>
	<script type="text/javascript" src="/mivlab/lib/iscroll/iscroll-probe.js"></script>
	<script type="text/javascript" src="/mivlab/lib/amazeui/amazeui.min.js"></script>
	<script type="text/javascript" src="/mivlab/lib/raty/jquery.raty.js"></script>
	<script type="text/javascript" src="/mivlab/js/main.min.js?t=1"></script>
                ...
                <div class="cm-type">
                	...
                	<c:forEach varStatus="st" var="a" items="${alist }">
                		<c:if test="${st.index==0 }">
	                        <li class="on" ><a style="text-align:center;padding:50px" href="#" onclick="return false;" >${a.otname }</a></li>
