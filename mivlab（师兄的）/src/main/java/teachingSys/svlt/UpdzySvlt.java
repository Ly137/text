...
/**
 * Servlet implementation class UpdzySvlt
 */
@WebServlet("/UpdzySvlt")
public class UpdzySvlt extends HttpServlet {
	/**
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(file!=null){
			...
			String sql="update zyinfo set syinfo_id="+syinfo_id+",zytitle='"+zytitle+"',zyword='"+filename+"' where id="+id;
