...
<head>
    ...
    <title>基于GitHub的教学管理系统——实验任务>详情</title>
            ...
            <div class="row row-cards">
              <div class="col-12 card">              
                  <div class="page-header">		                
		              <h1 class="page-title">
		                 <a href="<%=basePath %>InitSvlt?flgs=1&tbname=stutaskinfo"><i class="fe fe-corner-up-left" ></i></a>
		                	实验任务>详情
		              </h1>
		          </div>
                  <div class="card-body">
	                    ...
	                    <div class="row"> 
	                      ...
	                      <div class="col-sm-6 col-md-6 col-lg-4">
	                       ...
	                       <div class="col-sm-12 col-md-12 col-lg-12 editor"> 
	                        <div class="form-group">
	                          <label class="form-label">编辑作业</label>
	                           <textarea class="form-control"   name="content" id="editor" ></textarea>	                        
	                        </div>	
	                       </div>
	                       <div class="col-sm-12 col-md-12 col-lg-12">                        
	                        <div class="form-footer">
		                      <button class="btn btn-primary  ml-auto btnF" style="display:none;" >返 回</button>
		                      <button class="btn btn-primary  ml-auto btnSb" style="display:none;" >提交作业</button>
		                      <button class="btn btn-primary  ml-auto showeditor" >提交作业</button>
		                    </div>  
		                   </div>                     
	                   </div>
                      </div>
