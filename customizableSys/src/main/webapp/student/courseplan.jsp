...
<html>
	<head>
		...
		//查询
		function cktj(){
			var sqls="select termname,classno,classname,cno,cname,tNo,tName,sex,tPhone, courseplan.* from terms,classinfo,course,teacher, courseplan where 1=1  and terms.id=terms_id and classinfo.id=classinfo_id and course.id=course_id and teacher.id=courseplan.teacher_id ";
			var termsid=$("#cktermsid").combobox('getValue');
			if(termsid!="0"){
				sqls+=" and terms_id="+termsid;
			}
			sqls+=" and classinfo.id in(select classinfo_id from students where id="+${userid}+")";
			$.ajax({
				url:'CkSvlt',
				type:'post',
				data:{"sql":sqls},
				...
				success:function(data){
					if(data.msg==1){
						window.location.href="InitSvlt?tbname=stucourse";
					}else{
						alert(data.msg);
					}
				}
						...
						<tr>
							<td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
								<tr>
									...
									<td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">任课教师</span></strong></div></td>
									<td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">电话号码</span></strong></div></td>
								</tr>
										...
										<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td><table border="0" align="right" cellpadding="0" cellspacing="0">
													<tr>
														<td width="40"><a href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','stucourse');return false;"><img src="images/first.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','stucourse');return false;"><img src="images/back.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','stucourse');return false;"><img src="images/next.gif" width="37" height="15"/></a></td>
														<td width="40"><a href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','stucourse');return false;"><img src="images/last.gif" width="37" height="15"/></a></td>
