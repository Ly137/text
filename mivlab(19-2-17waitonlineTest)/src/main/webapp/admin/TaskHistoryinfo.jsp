...
<head>
    ...
    <title>基于GitHub的教学管理系统——学生提交实验记录>详情</title>
...
<div class="page">
            ...
            <div class="row row-cards">
              <div class="col-12 card">              
                  <div class="page-header">		                
		              <h1 class="page-title">
		                 <a href="<%=basePath %>InitSvlt?flgs=1&tbname=adminstutask"><i class="fe fe-corner-up-left" ></i></a>
		                	学生提交实验记录>详情
		              </h1>
		          </div>
                  <div class="card-body">
	                      ...
	                      <div class="col-sm-6 col-md-6 col-lg-4">
	                       ...
	                       <div class="col-sm-12 col-md-12 col-lg-12">
	                        <div class="form-group">
	                          <label class="form-label">作业要求</label>
	                           <textarea class="form-control" disabled="" name="remark" id="remark"></textarea>	 	                              	                         
	                        </div>
	                       </div>
	                       <div class="col-sm-12 col-md-12 col-lg-12"> 
	                        <div class="form-group">
	                       ...
	                       <div class="col-sm-12 col-md-12 col-lg-12">                        
	                        <div class="form-footer">
		                      <button class="btn btn-primary btn-block" onclick="redirect()">返 回</button>
		                    </div>  
		                   </div>                     
	                   </div>
                      </div>
	...
	$(document).ready(function(){
		...
		/*返回按钮*/
		function redirect(){
			  window.location.href="<%=basePath%>InitSvlt?flgs=1&tbname=adminstutask";
		};
