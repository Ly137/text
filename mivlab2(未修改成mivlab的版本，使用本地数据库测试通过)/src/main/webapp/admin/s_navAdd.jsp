...
<title>二级导航栏--添加</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<script type="text/javascript" src="<%=basePath%>js/jquery-3.3.1.min.js"></script>
<script src="/mivlab2/ckeditor5/ckeditor.js"></script>		<!-- 引入web在线文本编辑器的配置文件 -->
    	...
    	if (editor) {
    		...
    		if(name=="" || remark=="<p>&nbsp;</p>" || fnav_id==""){
    			...
    			$.ajax({
    				url:'/mivlab2/AddSvlt',
    				type:'post',
    				data:{"tbname":"snav","name":name,"remark":remark,"fnav_id":fnav_id},
    				dataType:'json',
...
<header class="am-topbar am-topbar-fixed-top">	
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title"><span class="fa fa-mail-reply backward" ></span> 二级标题管理>添加</h4></li>
				</ul>
								...
								<form  class="am-form" data-am-validator>
								  <fieldset>								    								
								    ...
								    <div class="am-form-group">
								      ...
								      <textarea name="snav_name" id="snav_name" minlength="0" maxlength="200"></textarea>
								    </div>
								    <div class="am-form-group">
								    ...
								    <button class="am-btn am-btn-secondary" type="button" onclick="redirect()">取消</button>
								    <button class="am-btn am-btn-secondary" type="button" onclick="onSubmit()">新增</button>
								  </fieldset>
								</form>
